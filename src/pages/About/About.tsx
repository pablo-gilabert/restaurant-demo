import Logo from "../../assets/img/icons/mathilde.webp"
...
// Shows the restaurant location, brand and embedded map.
const About = () => {
  return (
    <>
      <SEO
      ...
      <main className="about">
        <h1 className="aboutTitle">¿Dónde estamos?</h1>
        <p className="aboutDescription">Guernica, Calle 6 N° 110</p>
        <p className="aboutDescription">¡Te esperamos!</p>

        <img className="aboutLogo" src={Logo} alt="Mathilde Resto" loading="lazy"/>
